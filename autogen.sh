...
function print_usage() {
    ...
    echo "  -l, --add-langvar   Add env. variable \$GTLANG_non to login script."
...
# the current dir:
if   test x${GTLANG_non} = x ; then
	echo "WARNING: The variable \${GTLANG_non} has not been defined. You"
	...
	echo "$0 -l"
	echo
elif test x${GTLANG_non} != x${LANGDIR} ; then
	echo "WARNING: The variable \${GTLANG_non} has the value:"
	echo "  ${GTLANG_non}"
