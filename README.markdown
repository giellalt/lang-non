...
This directory contains source files for the Old Norse language
...
-   <https://giellalt.uit.no/lang/non/index.html> (analyser)
...
The Old Norse language sources can be acquired using [giella SVN
